...
public class AppCenter.Views.AppInfoView : Gtk.Box {
    ...
    private Widgets.HumbleButton action_button;
    private Gtk.Button open_button;
    private Gtk.Box button_box;
    private ProgressButton cancel_button;
    ...
    private void update_action () {
        ...
        switch (package.state) {
            ...
            case AppCenterCore.Package.State.INSTALLED:
                ...
                open_button_revealer.reveal_child = package.get_can_launch ();
