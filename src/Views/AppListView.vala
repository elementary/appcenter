...
namespace AppCenter.Views {
    ...
    public class AppListView : AbstractAppList {
        ...
        protected override Widgets.AppListRow make_row (AppCenterCore.Package package)  {
            return (Widgets.AppListRow)(new Widgets.PackageRow (package, action_button_group, false, false));
        }
    }
    ...
    public class AppListUpdateView : AbstractAppList {
        ...
        protected override Widgets.AppListRow make_row (AppCenterCore.Package package) {
            return (Widgets.AppListRow)(new Widgets.PackageRow (package, action_button_group, true, false));
        }
