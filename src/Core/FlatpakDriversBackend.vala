...
public class AppCenterCore.FlatpakDriversBackend : Backend, Object {
    ...
    private static GLib.Once<FlatpakDriversBackend> instance;
    public static unowned FlatpakDriversBackend get_default () {
        return instance.once (() => { return new FlatpakDriversBackend (); });
    }
}
