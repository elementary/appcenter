...
public class AppCenterCore.PkBackend : AppCenterCore.Backend, Object {
    ...
    private static GLib.Once<PkBackend> instance;
    public static unowned PkBackend get_default () {
        return instance.once (() => { return new PkBackend (); });
    }
}
